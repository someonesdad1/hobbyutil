...
A macro processor; print the man page (mp.py -h) for details.
'''
...
special_macros = '''      mp_NowDateDMY     Is the current date in DD MMM YYYY format.
      ...
      mp_GPL_html       The GNU General Public License Notice (html)'''
...
DESCRIPTION
    ...
    %(script)s doesn't behave this way; it's just no-brainer text
    substitution.
